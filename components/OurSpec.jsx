...
const OurSpecs = () => {
    ...
    return (
        <div className='px-6 my-20 max-w-6xl mx-auto'>
            <Title visibleButton={false} title='Spesifikasi Kami' description="Kami menawarkan layanan dan kenyamanan tingkat atas untuk memastikan pengalaman belanja Anda lancar, aman, dan sepenuhnya bebas gangguan." />
