...
const Footer = () => {
    ...
    const linkSections = [
        ...
        },
        {
            ...
            links: [
                ...
                { text: "Bandar Lampung, 94102", path: '/', icon: MapPinIcon }
            ]
        }
    ];
    ...
    const socialIcons = [
        ...
        { icon: InstagramIcon, link: "https://www.instagram.com/krisnatfk_" },
        { icon: TwitterIcon, link: "https://twitter.com" },
        { icon: LinkedinIcon, link: "https://www.linkedin.com/in/krisna-taufik/" },
    ]
        ...
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link href="/" className="text-4xl font-semibold text-slate-700">
                            <span className="text-green-600">Kris</span>Mart<span className="text-green-600 text-5xl leading-0">.</span>
                        </Link>
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to KrisMart, your ultimate destination for the latest and smartest gadgets. From smartphones and smartwatches to essential accessories, we bring you the best in innovation — all in one place.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © KrisMart All Right Reserved.
                </p>
            </div>
        </footer>
    );
